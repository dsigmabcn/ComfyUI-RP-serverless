...
class Payload_ZIT:
    @staticmethod
    def _apply_extras(args, cfg_norm, sigmas=None, lora_path=None):
    ...
    @staticmethod
    def txt2img(prompt, width, height, steps, seed, guidance_scale, cfg_norm, sigmas=None, lora_path=None):
        args = {
            "prompt": prompt,
            "width": width,
            "height": height,
        ...
        return {"pipe_type": "base", "pipeline_args": Payload_ZIT._apply_extras(args, cfg_norm, sigmas, lora_path)}

    @staticmethod
    def img2img(prompt, strength, steps, seed, guidance_scale, image_b64, cfg_norm, sigmas=None, lora_path=None):
        args = {
            "prompt": prompt,
            "image": image_b64,
            "strength": strength,
        ...
        return {"pipe_type": "i2i", "pipeline_args": Payload_ZIT._apply_extras(args, cfg_norm, sigmas, lora_path)}

    @staticmethod
    def inpaint(prompt, image_b64, mask_b64, steps, seed, guidance_scale, cfg_norm, sigmas=None, lora_path=None):
        args = {
            "prompt": prompt,
            "image": image_b64,
            "mask_image": mask_b64,
        ...
        return {"pipe_type": "inpaint", "pipeline_args": Payload_ZIT._apply_extras(args, cfg_norm, sigmas, lora_path)}